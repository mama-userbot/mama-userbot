...
DEFAULTUSER = ALIVE_NAME or "Mama-userbot User"
HELL_IMG = Config.ALIVE_PIC
CUSTOM_ALIVE_TEXT = Config.ALIVE_MSG or "ʟɛɢɛռɖaʀʏ_ᴀғ_mama-userbot"
...
@bot.on(sudo_cmd(pattern="mama$", allow_sudo=True))
